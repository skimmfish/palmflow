...
<main id="content" role="main">
    ...
    <div class="bg-img-start" style="background-image: url({{ asset('svg/components/card-11.svg') }} );">
      <div class="container content-space-t-3 content-space-t-lg-5 content-space-b-2">
        <div class="w-md-75 w-lg-50 text-center mx-md-auto">
          ...
          <p><small style="font-weight:500;color:#000;">Here are the terms & conditions that governs our crypto staking project. <i class="text-info text-xs">Last Updated 15/06/2022</i></small></p>
        </div>
      </div>
    </div>
  ...
  <p style="font-family:'GD Sherpa Regular','Spartan','Work Sans','Brandon Grotesque'; font-size:14px;font-weight:500;">
  <b>TERMS OF SERVICE</b><br/>
  
OliveFlow, LLC (“OliveFlow”, the “Company,” “Us,” “Our” or “We”), by and through https://OliveFlow.com (the “Site”), operates, hosts and monitors and trade stable cryptocurrencies - USDT & by extension USDC against other currencies - Euro, and the Great Britain Pounds (as defined below, the “Services”). 
OliveFlow provides Services pursuant to, and in accordance with, the following terms and conditions (this “Agreement” or “Terms of Use”). The Foundation Project ("Help the Poor Project - A health initiative to help those hospitalized without means to afford health bills")
Accessing, browsing or viewing the Site, including, but not limited to, registering for an account, submitting any information to Us, or utilizing any of the Services as provided and offered by OliveFlow, you hereby consent and agree to be bound by these Terms of Use, as contained herein.
...
<b>“Client Data”</b> means all data, files and information that Client provides to OliveFlow in the course of using the Services.<br/>
<b>“Client Funds”</b> means the Cryptocurrency funds staked or donated by Client to OliveFlow either for charity purposes or contributory purpose upon which a daily rebate is applicable as means of giving back to our contributors whom we see as wallet reservestakeholders in the interest of our "Help the poor Project".<br/>
<b>“Net Revenue”</b> means Staking Rewards minus any transactional charges assessed, if applicable. <br/>
<b>“Pooled Staking Service”</b> means the OliveFlow Service that runs Trading activities on the pooled funds and allows investors to Stake their Cryptocurrency holdings in exchange for a percentage of the Net Revenue generated from Staking. <Br/>
...
<b>“Supported Protocol”</b> means a Cryptocurrency for which OliveFlow operates Staking Nodes. <br/>
...
<BR/>
<BR/>
<B>2. OliveFlow RESPONSIBILITIES</B><BR/>

a. Trading Services. During the Term, OliveFlow will provide the Trading Services on behalf of The Foundation Project and by extension the Client's MT4 accounts bound with our servers from the backend in accordance with the service level terms set forth below.<br/>
b. Server Procurement, Setup, Broker & Market selection & Maintenance. OliveFlow will determine, in its sole discretion, the network and server requirements to reliably use in our trading activities. 
OliveFlow is responsible for all costs associated with procuring, installing servers, expert algorithms and running trading activities.<br/>
c. Revenue Share Payments: OliveFlow will pay Client a percentage of Net Revenue directly attributable to Client Funds. 
...
d. Reporting: OliveFlow will provide regular reports through our dashboard detailing the performance of the Services to Client with respect to wallet reserve staking program, but as for MT4 trading activities, every client would see the history of trading and for such we do not give reports except on ancilliary issues that affects clients' account. Such reports will provide mutually agreeable details to enable the accurate calculation of Net Revenue.

<BR/><B>3. CLIENT RESPONSIBILITIES</B><BR/>
a. Stake Delegation. Client will have the sole right to determine the amount of Client Funds and End Users Funds which will be OliveFlow pursuant to this Agreement.
b. Withdrawals. Client acknowledges and agrees that Client Funds and End Users Funds reserved for staking via the wallet reserve which have been OliveFlow's, pursuant hereto may not be withdrawn prior to the conclusion of the Unbonding Period which is 6 months from the time of staking. For clarity purposes, withdrawals are only permitted on rewards tagged as "withdrawable balance" on the client's dashboard.
...
OliveFlow makes no representations in this regard. Client agrees to indemnify and hold OliveFlow harmless against any taxes, including penalties, duties and interest levied by any government on the Revenue Share Payments.

<BR/><B>4. LICENSE GRANT; RESTRICTIONS</B><BR/>
a. Proprietary Rights. Client acknowledges and agrees that this license conveys no title or ownership rights to the OliveFlow Services. 
Client does not acquire any rights in the Services, express or implied, other than those expressly granted in this Agreement and all rights not expressly granted to Client are reserved by OliveFlow. <br/>
OliveFlow retains all right, title and interest in and to the OliveFlow Services, including without limitation, all unpatented inventions, patent applications, patents, design rights, copyrights, trademarks, service marks, trade names, know-how and other trade secret rights, and all other intellectual property rights, derivatives or improvements thereof.<br/>
b. Restrictions. Client will not, and will not permit any other third party to modify, reproduce, copy, reverse engineer, decompile, reverse assemble or otherwise attempt to discover the source code or algorithms for the OliveFlow Services, or access the Services in order to build a similar or competitive product or service. 
...
The OliveFlow Services may not be used in any jurisdiction for unlawful, obscene, offensive or fraudulent content or activity, such as advocating or causing harm, interfering with or violating the integrity or security of a network or system, evading filters, sending unsolicited, abusive, or deceptive messages, viruses or harmful code, or violating third party rights. If there is a complaint or notice of violation, use may be suspended until resolved, and terminated if not resolved promptly.
...
In addition, OliveFlow may terminate this Agreement on seven (7) days written notice for any reason or no reason whatsoever.<br/>
...
a. Representations and Warranties by OliveFlow. OliveFlow represents and warrants to Client that: <br/>
(i) it has the power and authority to enter into this Agreement, <br/>
(ii) entering into this Agreement will not be a breach or violation of any other contract or agreement to which OliveFlow is bound, <br/>
...
b. Representations and Warranties by Client. Client represents and warrants to OliveFlow that: 
...
c. Disclaimer. EXCEPT FOR THE EXPRESS WARRANTIES STATED IN THIS SECTION 7, NEITHER PARTY MAKES, AND EACH PARTY EXPRESSLY DISCLAIMS, ALL WARRANTIES, EXPRESS, IMPLIED, STATUTORY OR OTHERWISE, WITH RESPECT TO THE SERVICES AND THE SUBJECT MATTER OF THIS AGREEMENT, INCLUDING WITHOUT LIMITATION IMPLIED WARRANTIES OF ACCESS, MERCHANTABILITY, FITNESS FOR A PARTICULAR PURPOSE, AND IMPLIED WARRANTIES ARISING FROM COURSE OF DEALING OR COURSE OF PERFORMANCE. EXCEPT AS STATED IN THIS SECTION 7(a), THE SERVICES ARE PROVIDED TO CLIENT ON AN “AS IS” AND “AS AVAILABLE” BASIS, AND ARE FOR COMMERCIAL USE ONLY. Client understands that while OliveFlow employs measures to ensure that the Services are accessible 24 hours a day/7 days a week, OliveFlow cannot guarantee the uninterrupted or error-free operation performance of the Services or that OliveFlow will correct all defects or prevent third party disruptions or unauthorized third party access. In the event of any inaccessibility of the OliveFlow Services, OliveFlow’s sole liability and obligation will as described in Exhibit A, which is hereby incorporated by reference. OliveFlow warranties will not apply if there has been misuse, modification, damage not caused by OliveFlow, failure to comply with instructions provided by OliveFlow, or if otherwise stated in in Exhibit A. 
Non-OliveFlow services are sold under the Agreement as-is, without warranties of any kind. Third parties may provide their own warranties to Client.

<BR/><B>8. LIMITATION OF LIABILITY</B><BR/>

OliveFlow’S ENTIRE LIABILITY FOR ALL CLAIMS RELATED TO THE AGREEMENT WILL NOT EXCEED THE AMOUNT OF ANY ACTUAL DIRECT DAMAGES INCURRED BY CLIENT, 
UP TO THE NET REVENUES ACTUALLY RECEIVED BY OliveFlow IN THE PRIOR 12 MONTHS WITH RESPECT TO THE SERVICES THAT ARE THE SUBJECT OF THE CLAIM, 
REGARDLESS OF THE BASIS OF THE CLAIM. OliveFlow WILL NOT BE LIABLE FOR SPECIAL, INCIDENTAL, EXEMPLARY, INDIRECT, OR ECONOMIC CONSEQUENTIAL DAMAGES, 
OR LOST PROFITS, BUSINESS, VALUE, REVENUE, GOODWILL, OR ANTICIPATED SAVINGS. 
THESE LIMITATIONS APPLY COLLECTIVELY TO OliveFlow, ITS AFFILIATES, CONTRACTORS AND END USERS. 
...
Client agrees to indemnify, defend and hold harmless OliveFlow, its partners, agents, officers, directors and employees, from and against any loss, cost, expense, claim, injury or damage (including, without limitation, reasonable attorneys’ fees and expenses) (collectively, “Losses”) incurred due to third party claims arising from any breach by Client of any representation, warranty, or provision in this Agreement. OliveFlow shall indemnify, defend and hold Client harmless from and against any Losses incurred due to third party claims arising from any breach by OliveFlow of any representation, warranty, or provision contained in this Agreement.
...
Neither party will issue any press releases or make any other public disclosures regarding this Agreement or its terms or the nature of the parties’ relationship without the other party’s prior written consent. Notwithstanding the foregoing, OliveFlow may list Client as a customer on its website and in marketing materials.
...
Client shall promptly notify OliveFlow of such notice or violation.
...
c. OliveFlow will not be liable for any delay or failure to perform any of its obligations set forth in this Agreement due to causes beyond its reasonable control.<Br/>
...
g. Any notice, demand or request required or permitted to be given under this Agreement shall be in writing and shall be deemed sufficient when sent by email to legal@OliveFlow.com. <br/>
...
“Trading Service Downtime” means the number of minutes that OliveFlow Brokers couldn't execute trades for a Supported trade call advisories, but does not include any downtime otherwise excluded under section 4 below.
“Force Majeure Events” means any downtime minutes that are the result of events or conditions beyond OliveFlow’s reasonable control. 
...
(ii) scheduled OliveFlow network maintenance, <br/>
...
No credits shall accrue under this Agreement until OliveFlow has actual notice of, or Client delivers to OliveFlow written notice of, the Trading Servers Downtime. 
...
OliveFlow shall deliver to Client detailed reporting specifying the approximate duration of the applicable failure and certifying to the best of OliveFlow’s knowledge the total amount of credits to which Client is entitled. In no event shall the total of any credits established under this Agreement for any month exceed the Net Revenue retained by OliveFlow during the applicable month. Credits will not carry over to future months. The credits provided shall be the sole remedies to Client in the event of the Staking Node Downtime.
