        ...
        <div class="row align-items-sm-center mb-5">
          ...
          <div class="col-sm-5">
            <div class="d-flex justify-content-sm-end align-items-center">
              <span class="text-cap me-2">Follow Us</span>
...
<ul class="olive">
  ...
  <li> Flash Cookies. Certain features of our Service may use local stored
    ...
    shared-objects-
    flash.html#main_Where_can_I_change_the_settings_for_disabling__or_deleting_local_shared_objects_></li>
...
<p class="olive">
 ...
 <b>   Purpose: These Cookies identify if users have accepted the use of cookies
    on the Website.
</b>
<Br/>
<Br/>
...
<p>
<h6 class="mb-0">Disclosure of Your Personal Data  </h6>
