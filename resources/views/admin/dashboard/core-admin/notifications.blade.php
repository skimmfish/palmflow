              ...
              <div class="row border-bottom border-200 hover-actions-trigger hover-shadow py-2 px-1 mx-0 bg-white dark__bg-dark" data-href="email-detail.html">
                ...
                <div class="col col-md-9 col-xxl-10" style="margin-bottom:14px;">
                  <div class="row">
                    ...
                    <div class="col"><a class="d-block inbox-link" href="{{route('admin.dashboard.core-admin.view-single',['id'=>$n->id])}}"><span class="fw-bold">{{$n->subject}}</span><span class="mx-1">&ndash;</span><span>{{ \Illuminate\Support\Str::limit($n->note,20)}}</span></a></div>
                  </div>
                </div>
