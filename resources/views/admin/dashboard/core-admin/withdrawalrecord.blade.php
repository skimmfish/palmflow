...
@include('layouts.admin_topbar')
		 ...
		 <div class="row">
			...
			<div class="container"> @if (session('message'))   <div class="alert alert-success alert-note-style">  {{ session('message') }}, 
                  ...
                  <div class="row">
				  <div class="col-6"><h5 style="margin:20px 0 20px 0">All Withdrawals' History</h5></div>
                    ...
                    <div class="row padding_bottom_20">
                     ...
                     <div class="col-3">
                        <label class="form-label">End Date</label><input type="date" name="ends_at" class="form-control input-sm'" placeholder="End Date"/></div>
                     <div class="col-3">
                         <label>Select period</label>
                         <select name="date_filter'" class="form-control input-md filterbyperiod">
                     ...
                     <div class="col-3" style="margin-top:20px;'"><button type="button" class="btn btn-primary btn-round" id="fetchRecords" onClick="fetchRecordsAll(start_at.value,ends_at.value,user_id.value,type.value)" name="fetch">Search <i class="fa fa-search"></i></button></div>
                    </div>
                    </form><Br/><br/>
		 ...
		 <div class="col-12" id="withdrawal_recs">
              <div class="card mb-3 btn-reveal-trigger">
                <div class="card-header position-relative min-vh-25 mb-12">
				  <small style="font-size:10.5px;color:#0d2453;font-weight:600;">Here is a list of all withdrawal records</small><br/><br/>
				  
				  <table class="table table-responsive table-bordered table_rws">
				  <thead>
                  <tr>
				  <th> <div class="grix"><div><input type="checkbox" name="select" value="1" id="selectAll" onChange="triggerSelect(this.value)"/></form></div><b>S/N</b></div></th>
				 ...
				 @foreach($withdrawals as $s)
				  <tr>
					<td><div class="grix"><div><form action="" method="POST">@csrf @method('any')<input type="checkbox" name="select" value="1"/>
                </form></div> <div>{{ $id++ }}</div></div></td>
                  ...
                  <a href="#" data-attr="" data-target="" data-toggle="modal" id="viewStat" class="text-primary">View Status</a> | <a href="" class="text-success">Archive</a>
