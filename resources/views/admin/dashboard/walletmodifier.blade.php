...
<a href="{{route('admin.dashboard.modwalletdefault',['id'=>$id]) }}" class="btn btn-primary btn-round text-xs">Yes</a> <a href="#" onclick="closeModal()" class="btn btn-danger btn-circle text-xs">No</a>
</div>
